...
public class RelationHandler<T> {
    ...
    public void handleRelations(T entity, long parentId, OperationType operationType) {
    ...
    public void handleOneToOneRelation(T entity, Field field, long parentId, OperationType operationType) throws IllegalAccessException {
        ...
        if (relatedEntity != null) {
            ...
            if (relatedValues.containsKey(metadata.getPrimaryKeyColumn(relatedEntity.getClass())) &&
                ...
                long relatedId = (Long) relatedValues.get(metadata.getPrimaryKeyColumn(relatedEntity.getClass()));
    ...
    public void handleOneToManyRelation(T entity, Field field, long parentId, OperationType operationType) throws IllegalAccessException {
    ...
    public void handleManyToManyRelation(T entity, Field field, long parentId, OperationType operationType) throws IllegalAccessException {
        ...
        if (operationType != OperationType.DELETE && relatedEntities != null) {
            for (Object relatedEntity : relatedEntities) {
                Map<String, Object> relatedValues = metadata.extractColumnValues(relatedEntity);
                long relatedId = (Long) relatedValues.get(metadata.getPrimaryKeyColumn(relatedEntity.getClass())); // Obtiene el ID de la entidad relacionada
    ...
    public void handleRelationsBeforeDelete(long parentId) {
        for (Field field : entityClass.getDeclaredFields()) {
