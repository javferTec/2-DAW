...
-- Insert categories
INSERT INTO categories (name_es, name_en, slug)
VALUES ('Novedades', 'New Releases', 'new-releases'),
...
INSERT INTO bookstore.books (isbn, title_es, title_en, synopsis_es, synopsis_en, price, discount, cover, publisher_id,
                             category_id)
VALUES ('9780142424179', 'El principito', 'The Little Prince',
        ...
        15.99, 10.00, 'http://images.cesguiro.es/books/9780142424179.webp', 1, 1),
       ('9780142410363', 'Matilda', 'Matilda',
        ...
        14.99, 5.00, 'http://images.cesguiro.es/books/9780142410363.webp', 2, 2),
       ('9780142418222', 'Charlie y la fábrica de chocolate', 'Charlie and the Chocolate Factory',
        ...
        13.99, 15.00, 'http://images.cesguiro.es/books/9780142418222.jpeg', 2, 4),
       ('9780060256654', 'Donde viven los monstruos', 'Where the Wild Things Are',
        ...
        16.99, 15.00, 'http://images.cesguiro.es/books/9780060256654.webp', 3, 4),
       ('9780618260300', 'El león, la bruja y el armario', 'The Lion, the Witch and the Wardrobe',
        ...
        18.99, 0.00, 'http://images.cesguiro.es/books/9780618260300.webp', 3, 3),
       ('9780439554930', 'Harry Potter y la piedra filosofal', 'Harry Potter and the Sorcerer''s Stone',
        ...
        19.99, 15.00, 'http://images.cesguiro.es/books/9780439554930.webp', 4, 4),
       ...
       ('9780064400558', 'Alicia en el país de las maravillas', 'Alice''s Adventures in Wonderland',
        ...
        11.99, 0.00, 'http://images.cesguiro.es/books/9780064400558.webp', 5, 2),
       ('9780439023528', 'Los juegos del hambre', 'The Hunger Games',
        ...
        19.99, 0.00, 'http://images.cesguiro.es/books/9780439023528.webp', 3, 3),
       ('9781423103349', 'Percy Jackson y el ladrón del rayo', 'Percy Jackson and the Olympians: The Lightning Thief',
        ...
        17.99, 0.00, 'http://images.cesguiro.es/books/9781423103349.webp', 4, 1);
INSERT INTO bookstore.books (isbn, title_es, title_en, synopsis_es, synopsis_en, price, discount, cover, publisher_id,
                             category_id)
VALUES ('9780316015844', 'Crepúsculo', 'Twilight',
        ...
        15.99, 0.00, 'http://images.cesguiro.es/books/9780316015844.webp', 2, 2),
       ('9780062024039', 'Divergente', 'Divergent',
        ...
        18.99, 10.00, 'http://images.cesguiro.es/books/9780062024039.webp', 5, 3),
       ('9781416914280', 'Cazadores de sombras: Ciudad de hueso', 'The Mortal Instruments: City of Bones',
        ...
        17.99, 15.00, 'http://images.cesguiro.es/books/9781416914280.webp', 1, 4),
       ('9780385737951', 'El corredor del laberinto', 'The Maze Runner',
        ...
        16.99, 15.00, 'http://images.cesguiro.es/books/9780385737951.webp', 3, 4),
       ('9781250047819', 'Eleanor & Park', 'Eleanor & Park',
        ...
        14.99, 5.00, 'http://images.cesguiro.es/books/9781250047819.webp', 4, 1),
       ('9780142424180', 'Bajo la misma estrella', 'The Fault in Our Stars',
        ...
        15.99, 15.00, 'http://images.cesguiro.es/books/9780142424180.webp', 2, 4),
       ('9780618260400', 'El hobbit', 'The Hobbit',
        ...
        14.99, 0.00, 'http://images.cesguiro.es/books/9780618260400.jpg', 3, 2),
       ('9780261103573', 'El señor de los anillos: La comunidad del anillo',
        ...
        19.99, 0.00, 'http://images.cesguiro.es/books/9780261103573.webp', 3, 3),
       ('9780261102361', 'El señor de los anillos: Las dos torres', 'The Lord of the Rings: The Two Towers',
        ...
        19.99, 0.00, 'http://images.cesguiro.es/books/9780261102361.webp', 3, 1),
       ('9780316029186', 'El último deseo', 'The Last Wish',
        ...
        18.99, 10.00, 'http://images.cesguiro.es/books/9780316029186.jpg', 4, 2);

INSERT INTO bookstore.books (isbn, title_es, title_en, synopsis_es, synopsis_en, price, discount, cover, publisher_id,
                             category_id)
VALUES ('9780316073797', 'La espada del destino', 'Sword of Destiny',
        ...
        18.99, 5.00, 'http://images.cesguiro.es/books/9780316073797.jpeg', 4, 3),
       ('9780060557912', 'Buenos presagios', 'Good Omens',
        ...
        16.99, 0.00, 'http://images.cesguiro.es/books/9780060557912.jpg', 5, 2),
       ('9780060853983', 'American Gods', 'American Gods',
        ...
        17.99, 15.00, 'http://images.cesguiro.es/books/9780060853983.webp', 5, 4),
...
VALUES ('Antoine de Saint-Exupéry', 'French',
       ...
       ('Maurice Sendak', 'American',
        'Maurice Sendak was an American illustrator and writer of children''s books. He became widely known for his bookQuery Where the Wild Things Are.',
       ...
       ('C.S. Lewis', 'British',
        ...
        1898, 1963),
       ('J.K. Rowling', 'British', 'J.K. Rowling is a British authorQuery, best known for the Harry Potter series.',
        'J.K. Rowling es una autora británica, conocida por la serie Harry Potter.', 1965, NULL),
       ('Munro Leaf', 'American',
        'Munro Leaf was an American authorQuery of children''s literature who wrote The Story of Ferdinand.',
       ...
       ('Suzanne Collins', 'American',
        'Suzanne Collins is an American television writer and authorQuery, best known for The Hunger Games series.',
       ...
       ('Rick Riordan', 'American',
        'Rick Riordan is an American authorQuery, best known for writing the Percy Jackson & the Olympians series.',
       ...
       ('Cassandra Clare', 'American',
        'Cassandra Clare is an American authorQuery of young adult fiction, best known for her series The Mortal Instruments.',
       ...
       ('James Dashner', 'American',
        'James Dashner is an American authorQuery of speculative fiction, primarily series for children or young adults, such as The Maze Runner.',
       ...
       ('Rainbow Rowell', 'American',
        'Rainbow Rowell is an American authorQuery known for young adult and adult contemporary novels, including Eleanor & Park.',
        ...
        1973, NULL),
       ('John Green', 'American',
        'John Green is an American authorQuery and YouTube content creator. He is the authorQuery of Looking for Alaska and The Fault in Our Stars.',
       ...
       ('Terry Pratchett', 'British',
        'Terry Pratchett was an English authorQuery of fantasy novels, best known for his Discworld series.',
        'Terry Pratchett fue un autor inglés de novelas de fantasía, conocido por su serie Mundodisco.', 1948, 2015),
       ('Neil Gaiman', 'British',
        'Neil Gaiman is an English authorQuery of short fiction, novels, comic books, graphic novels, audio theatre, and films. His notable works include the comic bookQuery series The Sandman and novels Stardust, American Gods, and Good Omens.',
       ...
       ('Andrzej Sapkowski', 'Polish',
        'Andrzej Sapkowski is a Polish fantasy writer, best known for his bookQuery series The Witcher.',
...
INSERT INTO users (username, password, email, first_name, last_name, address, language, is_admin)
VALUES ('admin', 'admin', 'admin@example.com', 'Admin', 'User', '999 Admin Street', 'en', 1),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (1, 7, 'Review for bookQuery 1 by user 7', 1),
       ...
       (2, 1, 'Review for bookQuery 2 by user 1', 2);
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (3, 8, 'Review for bookQuery 3 by user 8', 5),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (4, 3, 'Review for bookQuery 4 by user 3', 3),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (6, 8, 'Review for bookQuery 6 by user 8', 4),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (8, 4, 'Review for bookQuery 8 by user 4', 5),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (9, 5, 'Review for bookQuery 9 by user 5', 4),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (11, 8, 'Review for bookQuery 11 by user 8', 1),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (12, 3, 'Review for bookQuery 12 by user 3', 1),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (13, 9, 'Review for bookQuery 13 by user 9', 5),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (15, 8, 'Review for bookQuery 15 by user 8', 5),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (17, 10, 'Review for bookQuery 17 by user 10', 2),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (18, 1, 'Review for bookQuery 18 by user 1', 3),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (19, 6, 'Review for bookQuery 19 by user 6', 1),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (21, 7, 'Review for bookQuery 21 by user 7', 1),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (22, 6, 'Review for bookQuery 22 by user 6', 1),
...
INSERT INTO bookstore.reviews (book_id, user_id, review, rating)
VALUES (24, 8, 'Review for bookQuery 24 by user 8', 3),
