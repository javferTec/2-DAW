...
INSERT INTO books (isbn, title_es, title_en, synopsis_es, synopsis_en, price, discount, cover, publisher_id, category_id) VALUES
    ...
    'El principito es una novela corta y la obra más famosa del escritor y aviador francés Antoine de Saint-Exupéry. La historia es filosófica y se trata de un joven príncipe que viaja de planeta en planeta,
        conociendo personajes que muestran distintas facetas de la naturaleza humana. En su viaje,
        el principito aprende sobre la soledad, el amor, la pérdida y la amistad.',
    'The Little Prince is a novella and the most famous work of the French writer and aviator Antoine de Saint-Exupéry. The story is philosophical and involves a young prince who travels from planet to planet,
        meeting characters who show different aspects of human nature. In his journey,
        the little prince learns about loneliness, love, loss, and friendship.',
    15.99, 0.00, ' 9780142424179. jpg ', 1, NULL),

    (' 9780142410363 ', ' Matilda ', ' Matilda ',
    ' Matilda es una niña prodigio con unos padres terriblemente negligentes.A pesar de su ambiente familiar hostil,
        Matilda descubre su amor por la lectura y su capacidad telequinética. Cuando comienza la escuela,
        se encuentra con la terrible directora, la señorita Trunchbull,
        pero también con la amable señorita Honey. Con el tiempo, Matilda usa sus poderes para enfrentarse a las injusticias de los adultos en su vida.',
    'Matilda is a prodigy child with terribly negligent parents. Despite her hostile family environment,
        Matilda discovers her love for reading and her telekinetic ability. When she starts school,
        she encounters the terrible headmistress Miss Trunchbull, but also the kind Miss Honey. Over time, Matilda uses her powers to fight against the injustices of the adults in her life.',
    14.99, 0.00, '9780142410363.jpg', 2, NULL),

    ('9780142418222', 'Charlie y la fábrica de chocolate', 'Charlie and the Chocolate Factory',
    'Charlie Bucket es un niño pobre que vive con su familia cerca de la gigantesca fábrica de chocolate de Willy Wonka. Un día,
        Willy Wonka decide abrir las puertas de su fábrica a cinco niños afortunados que encuentren un billete dorado dentro de las chocolatinas Wonka. Charlie,
        contra todo pronóstico, encuentra uno de los billetes y su vida cambia para siempre al descubrir los secretos y maravillas de la fábrica de chocolate.',
    'Charlie Bucket is a poor boy living with his family near Willy Wonka\'s gigantic chocolate factory. One day, Willy Wonka decides to open the doors of his factory to five lucky children who find a golden ticket inside Wonka chocolate bars. Charlie, against all odds, finds one of the tickets, and his life changes forever as he discovers the secrets and wonders of the chocolate factory.',
       ...
       ('9780060256654', 'Donde viven los monstruos', 'Where the Wild Things Are',
        ...
        'Where the Wild Things Are is a children\'s book written and illustrated by Maurice Sendak. The book tells the story of Max,
        a mischievous boy who embarks on an adventure to a world of wild monsters after being sent to bed without dinner. In this imaginary world,
        Max becomes the king of the monsters but soon realizes he misses his family and decides to return home.',
    ...
    'Harry Potter es un niño huérfano que vive con sus abusivos tíos. En su undécimo cumpleaños,
        descubre que es un mago y es invitado a asistir al Colegio Hogwarts de Magia y Hechicería. Allí, Harry hace amigos y enemigos y descubre la verdad sobre sus padres y su conexión con el mago oscuro Voldemort.',
    'Harry Potter is an orphaned boy living with his abusive aunt and uncle. On his eleventh birthday,
        he discovers he is a wizard and is invited to attend the Hogwarts School of Witchcraft and Wizardry. There,
        Harry makes friends and enemies and learns the truth about his parents and his connection to the dark wizard Voldemort.',
    19.99, 0.00, '9780439554930.jpg', 4, NULL),

    ('9781451673319', 'El cuento de Ferdinando', 'The Story of Ferdinand',
    'El cuento de Ferdinando es una historia infantil escrita por Munro Leaf e ilustrada por Robert Lawson. El libro cuenta la historia de un toro pacífico llamado Ferdinando que prefiere oler flores en lugar de luchar. Cuando es picado por una abeja,
        su comportamiento cambia y es llevado a una corrida de toros, pero finalmente regresa a su vida tranquila en el campo.',
    ...
    'Alicia en el país de las maravillas es una novela escrita por Lewis Carroll. La historia sigue a una joven llamada Alicia que cae por una madriguera de conejo y entra en un mundo fantástico lleno de criaturas peculiares y situaciones absurdas. A lo largo de su aventura,
        Alicia debe navegar por este mundo extraño y surrealista mientras trata de encontrar su camino de regreso a casa.',
    'Alice\'s Adventures in Wonderland is a novel written by Lewis Carroll. The story follows a young girl named Alice who falls down a rabbit hole and enters a fantastical world filled with peculiar creatures and absurd situations. Throughout her adventure, Alice must navigate this strange and surreal world as she tries to find her way back home.',
       ...
       ('9780261103573', 'El señor de los anillos: La comunidad del anillo',
       ...
       ('9780261102361', 'El señor de los anillos: Las dos torres', 'The Lord of the Rings: The Two Towers',
        ...
        'The Two Towers continues Frodo and Sam\'s mission to destroy the One Ring, while Aragorn, Legolas, and Gimli
        search for Merry and Pippin, who have been captured by orcs.',
...
VALUES ('Antoine de Saint-Exupéry', 'French',
       ...
       ('Roald Dahl', 'British',
        ...
        'Roald Dahl fue un novelista, cuentista, poeta, guionista y piloto de combate británico. Sus libros han vendido más de 250 millones de copias en todo el mundo.',
        1916, 1990),
       ('Maurice Sendak', 'American',
        'Maurice Sendak was an American illustrator and writer of children''s books. He became widely known for his book Where the Wild Things Are.',
        'Maurice Sendak fue un ilustrador y escritor estadounidense de libros infantiles. Se hizo conocido mundialmente por su libro Donde viven los monstruos.',
        1928, 2012),
       ('C.S. Lewis', 'British',
        'C.S. Lewis was a British writer and lay theologian. He is best known for his works of fiction, especially The Chronicles of Narnia.',
        'C.S. Lewis fue un escritor y teólogo laico británico. Es conocido por sus obras de ficción, especialmente Las crónicas de Narnia.',
        1898, 1963),
       ('J.K. Rowling', 'British', 'J.K. Rowling is a British author, best known for the Harry Potter series.',
        'J.K. Rowling es una autora británica, conocida por la serie Harry Potter.', 1965, NULL),
       ('Munro Leaf', 'American',
        'Munro Leaf was an American author of children''s literature who wrote The Story of Ferdinand.',
        'Munro Leaf fue un autor estadounidense de literatura infantil que escribió El cuento de Ferdinando.', 1905,
        1976),
       ('Lewis Carroll', 'British',
        'Lewis Carroll was an English writer, mathematician, logician, Anglican deacon, and photographer. He is best known for his fantasy works Alice''s Adventures in Wonderland and its sequel Through the Looking-Glass.',
        'Lewis Carroll fue un escritor, matemático, lógico, diácono anglicano y fotógrafo inglés. Es conocido por sus obras de fantasía Alicia en el país de las maravillas y su secuela A través del espejo.',
        1832, 1898),
       ('Suzanne Collins', 'American',
        'Suzanne Collins is an American television writer and author, best known for The Hunger Games series.',
        'Suzanne Collins es una guionista y autora estadounidense, conocida por la serie Los Juegos del Hambre.', 1962,
        NULL),
       ('Rick Riordan', 'American',
        'Rick Riordan is an American author, best known for writing the Percy Jackson & the Olympians series.',
        'Rick Riordan es un autor estadounidense, conocido por escribir la serie Percy Jackson y los dioses del Olimpo.',
        1964, NULL),
       ('Stephenie Meyer', 'American',
        ...
        'Stephenie Meyer es una novelista y productora de cine estadounidense, conocida por su serie de romance vampírico Crepúsculo.',
        1973, NULL),
       ('Veronica Roth', 'American',
        ...
        'Veronica Roth es una novelista y escritora de cuentos estadounidense, conocida por su trilogía debut Divergente, que fue un éxito de ventas en el New York Times.',
        1988, NULL),
       ('Cassandra Clare', 'American',
        'Cassandra Clare is an American author of young adult fiction, best known for her series The Mortal Instruments.',
        'Cassandra Clare es una autora estadounidense de ficción juvenil, conocida por su serie Cazadores de sombras.',
        1973, NULL),
       ('James Dashner', 'American',
        'James Dashner is an American author of speculative fiction, primarily series for children or young adults, such as The Maze Runner.',
        'James Dashner es un autor estadounidense de ficción especulativa, principalmente series para niños o jóvenes, como El corredor del laberinto.',
        1972, NULL),
       ('Rainbow Rowell', 'American',
        'Rainbow Rowell is an American author known for young adult and adult contemporary novels, including Eleanor & Park.',
        'Rainbow Rowell es una autora estadounidense conocida por sus novelas contemporáneas para jóvenes y adultos, incluyendo Eleanor & Park.',
        1973, NULL),
       ('John Green', 'American',
        'John Green is an American author and YouTube content creator. He is the author of Looking for Alaska and The Fault in Our Stars.',
        'John Green es un autor estadounidense y creador de contenido en YouTube. Es el autor de Buscando a Alaska y Bajo la misma estrella.',
        1977, NULL),
       ('Terry Pratchett', 'British',
        'Terry Pratchett was an English author of fantasy novels, best known for his Discworld series.',
        'Terry Pratchett fue un autor inglés de novelas de fantasía, conocido por su serie Mundodisco.', 1948, 2015),
       ('Neil Gaiman', 'British',
        'Neil Gaiman is an English author of short fiction, novels, comic books, graphic novels, audio theatre, and films. His notable works include the comic book series The Sandman and novels Stardust, American Gods, and Good Omens.',
        'Neil Gaiman es un autor inglés de cuentos, novelas, cómics, novelas gráficas, teatro audio y películas. Sus obras notables incluyen la serie de cómics The Sandman y las novelas Stardust, American Gods, y Good Omens.',
        1960, NULL),
       ('Andrzej Sapkowski', 'Polish',
        'Andrzej Sapkowski is a Polish fantasy writer, best known for his book series The Witcher.',
        'Andrzej Sapkowski es un escritor de fantasía polaco, conocido por su serie de libros The Witcher.', 1948,
        NULL),
       ('J.R.R. Tolkien', 'British',
        'J.R.R. Tolkien was an English writer, poet, philologist, and academic, best known for The Lord of the Rings.',
        'J.R.R. Tolkien fue un escritor, poeta, filólogo y académico inglés, conocido por El señor de los anillos.',
        1892, 1973);

-- Insert books_authors
INSERT INTO books_authors (book_id, author_id)
VALUES (1, 1),   -- El principito by Antoine de Saint-Exupéry
