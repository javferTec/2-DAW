package com.fpmislata.basespring.controller.roles.user.userMapper.book;
...
public interface BookUserMapper {
    ...
    // Mapea el atributo publisher de Book a publisherCollection de BookDetail
    @Mapping(target = "authorsCollection", source = "authorUsers")
    // El primer elemento es el atributo de BookDetail y el segundo es el atributo de Book
