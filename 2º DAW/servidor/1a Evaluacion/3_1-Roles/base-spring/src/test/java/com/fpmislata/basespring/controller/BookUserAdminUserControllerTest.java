...
import com.fpmislata.basespring.roles.user.controller.BookUserController;
...
public class BookUserAdminUserControllerTest {
    ...
    void testFindByIsbnMethodNotFound() throws Exception {
        // Arrange
        String isbn = "9999";
        when(bookUserService.findByIsbn(isbn)).thenThrow(new ResourceNotFoundException("Book with ISBN " + isbn + " not found"));
